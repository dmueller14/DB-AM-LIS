...
class GUIConfig(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.sidebar_frame = ctk.CTkFrame(self.tabview_frame, width=150)
        ...
        self.heading_label = ctk.CTkLabel(self.tabview_frame, text="Rechnungsdetails", font=("Arial", 20))
        ...
        self.tabview.grid(row=1, column=1, padx=10, pady=10)
